...
namespace LoRaWan.NetworkServer.BasicsStation
{
    ...
    internal sealed class BasicsStationNetworkServerDeviceManagerStartup
    {
        public IConfiguration Configuration { get; }
        public NetworkServerConfiguration NetworkServerConfiguration { get; }

        public BasicsStationNetworkServerDeviceManagerStartup(IConfiguration configuration)
        {
