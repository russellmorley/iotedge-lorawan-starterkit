...
namespace LoRaWan.Tests.Unit.NetworkServer
{
    ...
    public sealed class LoRaDeviceRegistryTest : MessageProcessorTestBase
    {
        ...
        public async Task GetDeviceForJoinRequestAsync_When_Device_Api_Throws_Error_Should_Not_Catch()
        {
            ...
            var apiService = new Mock<LoraDeviceManagerServicesBase>();
        ...
        public async Task When_Device_Is_Not_In_Cache_And_Found_In_Api_Should_Cache_And_Process_Request(string deviceGatewayID)
        {
            ...
            var apiService = new Mock<LoraDeviceManagerServicesBase>();
            var iotHubDeviceInfo = new IoTHubDeviceServiceInfo(simulatedDevice.LoRaDevice.DevAddr, simulatedDevice.LoRaDevice.DevEui, "pk") { GatewayId = deviceGatewayID };
            ...
            await using var target = new LoRaDeviceRegistry(ServerConfiguration, this.cache, apiService.Object, deviceFactory, DeviceCache);
        ...
        public async Task When_ABP_Device_Is_Created_Should_Call_Initializers(string deviceGatewayID)
        {
            ...
            var apiService = new Mock<LoraDeviceManagerServicesBase>();
            var iotHubDeviceInfo = new IoTHubDeviceServiceInfo(simulatedDevice.LoRaDevice.DevAddr, simulatedDevice.LoRaDevice.DevEui, string.Empty);
            apiService.Setup(x => x.SearchByDevAddrAsync(It.IsAny<DevAddr>()))
                .ReturnsAsync(new SearchDevicesResult(iotHubDeviceInfo.AsList()));

            await using var connectionManager = new SingleDeviceConnectionManager(LoRaDeviceClient.Object);
            await using var createdLoraDevice = TestUtils.CreateFromSimulatedDevice(simulatedDevice, connectionManager);
        ...
        public async Task When_Devices_From_Another_Gateway_Is_Cached_Return_Null()
        {
            ...
            await using var loraDevice1 = TestUtils.CreateFromSimulatedDevice(simulatedDevice1, ConnectionManager);
            ...
            var apiService = new Mock<LoraDeviceManagerServicesBase>(MockBehavior.Strict);
        ...
        public async Task When_Multiple_Devices_With_Same_DevAddr_Are_Cached_Should_Find_Matching_By_Mic(string deviceGatewayID)
        {
            ...
            await using var loraDevice1 = TestUtils.CreateFromSimulatedDevice(simulatedDevice1, connectionManager.Object);
            ...
            await using var loraDevice2 = TestUtils.CreateFromSimulatedDevice(simulatedDevice2, connectionManager.Object);
        ...
        public async Task When_Queueing_To_Multiple_Devices_With_Same_DevAddr_Should_Queue_To_Device_Matching_Mic(string deviceGatewayID)
        {
            ...
            var iotHubDeviceInfo1 = new IoTHubDeviceServiceInfo(devAddr, loraDevice1.DevEUI, string.Empty);
            var iotHubDeviceInfo2 = new IoTHubDeviceServiceInfo(devAddr, loraDevice2.DevEUI, string.Empty);
            var apiService = new Mock<LoraDeviceManagerServicesBase>();
            apiService.Setup(x => x.SearchByDevAddrAsync(devAddr))
                .ReturnsAsync(new SearchDevicesResult(new IoTHubDeviceServiceInfo[]
                {
                    iotHubDeviceInfo2,
                    iotHubDeviceInfo1,
                }));
        ...
        public async Task When_Device_Is_Assigned_To_Another_Gateway_Cache_Locally_And_Return_Null()
        {
            ...
            var apiService = new Mock<LoraDeviceManagerServicesBase>(MockBehavior.Strict);
            var iotHubDeviceInfo = new IoTHubDeviceServiceInfo(simulatedDevice.LoRaDevice.DevAddr, simulatedDevice.LoRaDevice.DevEui, "pk")
            {
        ...
        public async Task When_Device_Is_Assigned_To_Another_Gateway_After_No_Connection_Should_Be_Established()
        {
            ...
            var apiService = new Mock<LoraDeviceManagerServicesBase>(MockBehavior.Strict);
            var iotHubDeviceInfo = new IoTHubDeviceServiceInfo(simulatedDevice.LoRaDevice.DevAddr, simulatedDevice.LoRaDevice.DevEui, "pk") { NwkSKey = simulatedDevice.NwkSKey.Value, GatewayId = gatewayId };
            apiService.Setup(x => x.SearchByDevAddrAsync(It.IsAny<DevAddr>()))
                .ReturnsAsync(new SearchDevicesResult(iotHubDeviceInfo.AsList()));
        ...
        public async Task When_Cache_Clear_Is_Called_Should_Removed_Cached_Devices(string deviceGatewayID)
        {
            ...
            await target.ResetDeviceCacheAsync();
        ...
        public async Task When_Loading_Device_By_DevAddr_Should_Be_Able_To_Load_By_DevEUI()
        {
            ...
            var deviceApi = new Mock<LoraDeviceManagerServicesBase>(MockBehavior.Strict);
