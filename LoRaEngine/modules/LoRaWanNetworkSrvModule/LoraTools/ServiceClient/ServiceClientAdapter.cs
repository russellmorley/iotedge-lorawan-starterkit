...
namespace LoRaTools.ServiceClient
{
    ...
    public class ServiceClientAdapter : IServiceClient
    {
        ...
        public Task<CloudToDeviceMethodResult> InvokeDeviceMethodAsync(string deviceId,
                                                                       ...
                                                                       CancellationToken cancellationToken) => serviceClient.InvokeDeviceMethodAsync(deviceId, moduleId, cloudToDeviceMethod, cancellationToken);

        public Task SendAsync(string deviceId, Message message) => serviceClient.SendAsync(deviceId, message);
    }
}
